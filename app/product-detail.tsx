...
export default function ProductDetailScreen() {
  ...
  const handleDelete = () => {
    ...
    Alert.alert("Delete Product", "Are you sure you want to permanently delete this product from your Printful store?", [
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={["top"]}>
      ...
      <Modal animationType="slide" visible={showWebView} presentationStyle="pageSheet" onRequestClose={() => setShowWebView(false)}>
